...
-- ##############################################--STAFF--######################################################
-- if vRP.hasPermission(user_id, "poderes.permissao") or vRP.hasPermission(user_id, "paisanapoderes.permissao") then

-- 	if vRP.hasPermission(user_id, "poderes.permissao") then
-- 		status = 'Saiu'
-- 		vRP.addUserGroup(user_id, "PaisanaSuporte")

-- 	elseif vRP.hasPermission(user_id, "paisanapoderes.permissao") then
