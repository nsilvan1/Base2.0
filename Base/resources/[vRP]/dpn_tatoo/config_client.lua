            ...
            if parseInt(distance) < 3 then
                ...
                if Config_client['textoConfirm'] == true then
                   -- DrawText3D(v['x'], v['y'], v['z']-0.1,Config_client['texto'],0.5,3)
                    -- drawText2D("PRESSIONE [~r~E~w~] PARA ACESSAR",7,0.5,0.93,0.55,255,255,255,180)
                end
                if Config_client['blipConfirm'] == true then
                    ...
                    drawText2D("PRESSIONE [~r~E~w~] PARA ACESSAR",4,0.5,0.93,0.50,255,255,255,180)
                    DrawMarker(Config_client['blip'],v['x'], v['y'], v['z']-0.6,0,0,0,0.0,0,0,0.5,0.5,0.5, 174, 22, 22, 255,0,0,0,100)
                end
